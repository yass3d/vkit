...
const fn shortcut_label(shortcut: Shortcut) -> TextKey {
    match shortcut {
        ...
        Shortcut::HairPickTool => TextKey::HairToolVertex,
        ...
        Shortcut::VertexRotate => TextKey::HelpVertexRotate,
        ...
        Shortcut::LayerSelectAll => TextKey::ShortcutLayerSelectAll,
        Shortcut::LayerRemove => TextKey::ShortcutLayerRemove,
        Shortcut::VertexSelectConnected => TextKey::ShortcutVertexSelectConnected,
        Shortcut::VertexGrowSelection => TextKey::ShortcutVertexGrowSelection,
        Shortcut::VertexShrinkSelection => TextKey::ShortcutVertexShrinkSelection,
