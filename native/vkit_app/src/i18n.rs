...
text_keys! {
    ...
    HelpProjectionBrushSize,
    ShortcutProjectionBrushSize,
    HelpProjectionDone,
    ...
    RecoveryRestored,
    RecoveryLookMissing,
    SettingsOcclusionGroup,
    SettingsOcclusionIntensity,
    SettingsOcclusionRadius,
    SettingsBloomGroup,
    SettingsBloomIntensity,
    SettingsBloomThreshold,
    SettingsBloomSoftKnee,
    SettingsBloomRadius,
