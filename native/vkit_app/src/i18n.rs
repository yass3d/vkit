...
text_keys! {
    ...
    HairKeepSettledShape,
    HairKeepSettledShapeHint,
    HairMirrorEdit,
    HairMirrorEditHint,
    HairAutoPart,
    HairAutoPartHint,
    HairSingleStrand,
    HairSingleStrandHint,
    HairExportSection,
    HairExportBothSexes,
    ...
    ShortcutsResetAll,
    ShortcutGroupSystem,
    ShortcutGroupAlignment,
    ShortcutGroupSculpt,
    ShortcutGroupHair,
    ShortcutGroupView,
    ShortcutGroupNavigation,
    ShortcutViewReset,
    ShortcutViewProjection,
    ShortcutViewFront,
    ShortcutViewLeftSide,
    ShortcutViewRightSide,
    ShortcutViewTop,
    ShortcutViewBottom,
    ShortcutViewFrontUpperLeft,
    ShortcutViewFrontUpperRight,
    ShortcutViewFrontLowerLeft,
    ShortcutViewFrontLowerRight,
    ShortcutTabFaceMatch,
    ShortcutTabDetail,
    ShortcutTabTexture,
    ShortcutTabHair,
    ShortcutTabSave,
    ...
    ShortcutGroupVertex,
    ShortcutVertexAdd,
    ShortcutVertexRemove,
    ShortcutGroupTexture,
    ReferenceImages,
    ReferenceImagesEmpty,
    ReferenceImageUnreadable,
    ReferenceImageAdd,
    ReferenceImageRemove,
    ReferenceImageLock,
    ReferenceImageUnlock,
    ReferenceImageRaise,
    ReferenceImageLower,
    ReferenceHeadRow,
    ReferenceHeadRowHint,
    ShortcutTextureCanvasPan,
    ShortcutDiagnosticLogCopy,
    ShortcutLightRotate,
    ShortcutLayerHide,
    ...
    ShortcutLayerSelectAll,
    ShortcutLayerRemove,
    ShortcutVertexSelectConnected,
    ShortcutVertexGrowSelection,
    ShortcutVertexShrinkSelection,
    ShortcutSculptSmoothHold,
    ShortcutSculptInflateHold,
    ShortcutSculptAlternateHold,
    ShortcutHairSmoothHold,
    ShortcutHairInvertHold,
    ShortcutTextureInvertHold,
    ShortcutListAddToSelection,
    ShortcutListSolo,
    ShortcutsExport,
    ShortcutsImport,
    ShortcutsTaken,
