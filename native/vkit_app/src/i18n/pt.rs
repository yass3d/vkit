...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShowWornHair => Some("Mostrar o cabelo"),
        TextKey::ShowWornHairHint => Some("Em todos os separadores; não é alterado aqui"),
        ...
        TextKey::HairShowColliders => Some("Colisores"),
        TextKey::HairShowCollidersHint => Some(
            "Desenha contra o que o cabelo colide: cápsulas ao longo do pescoço, peito, clavículas e ombros. O jogo colide com estas, não com a pele.",
        ),
        ...
        TextKey::HairKeepSettledShapeHint => {
            Some("Corre a física em todas as partes e guarda onde as madeixas caíram.")
        }
        ...
        TextKey::HairSingleStrand => Some("Uma só madeixa"),
        TextKey::HairSingleStrandHint => {
            Some("Um traço edita apenas a madeixa em que começou, por onde quer que vá.")
        }
        ...
        TextKey::HairToolSettle => Some("Deixar cair"),
        TextKey::HairToolSettleHint => {
            Some("Deixa cair as madeixas sob o pincel e guarda onde aterram.")
        }
        ...
        TextKey::HairToolRigidityHint => Some(
            "A pintura de rigidez do VaM: com que força cada nó é puxado de volta à pose desenhada. O que for pintado duro mantém a forma e balança como uma peça; o pintado solto pende livre. Alt afrouxa. Verde é preso, vermelho é livre.",
        ),
        ...
        TextKey::RescanVaMFolder => Some("Verificar a pasta VaM novamente"),
        ...
        TextKey::ShortcutGroupSystem => Some("Em todo lugar"),
        TextKey::ShortcutGroupAlignment => Some("Posicionar a cabeça"),
        TextKey::ShortcutGroupSculpt => Some("Pincéis de escultura"),
        TextKey::ShortcutGroupHair => Some("Pincéis de cabelo"),
        TextKey::ShortcutGroupView => Some("Vistas da câmera"),
        TextKey::ShortcutGroupNavigation => Some("Trocar de aba"),
        TextKey::ShortcutViewReset => Some("Redefinir câmera"),
        TextKey::ShortcutViewProjection => Some("Perspectiva / ortográfica"),
        TextKey::ShortcutViewFront => Some("Vista frontal"),
        TextKey::ShortcutViewLeftSide => Some("Vista esquerda"),
        TextKey::ShortcutViewRightSide => Some("Vista direita"),
        TextKey::ShortcutViewTop => Some("Vista superior"),
        TextKey::ShortcutViewBottom => Some("Vista inferior"),
        TextKey::ShortcutViewFrontUpperLeft => Some("Frontal superior esquerda"),
        TextKey::ShortcutViewFrontUpperRight => Some("Frontal superior direita"),
        TextKey::ShortcutViewFrontLowerLeft => Some("Frontal inferior esquerda"),
        TextKey::ShortcutViewFrontLowerRight => Some("Frontal inferior direita"),
        TextKey::ShortcutTabFaceMatch => Some("Aba de ajuste facial"),
        TextKey::ShortcutTabDetail => Some("Aba de detalhe"),
        TextKey::ShortcutTabTexture => Some("Aba de textura"),
        TextKey::ShortcutTabHair => Some("Aba de cabelo"),
        TextKey::ShortcutTabSave => Some("Aba de salvar"),
        TextKey::ShortcutGroupLists => Some("Camadas e partes"),
        TextKey::ShortcutGroupVertex => Some("Nós da mecha"),
        TextKey::ShortcutVertexAdd => Some("Segurar para somar à seleção"),
        TextKey::ShortcutVertexRemove => Some("Segurar para tirar da seleção"),
        TextKey::ShortcutGroupTexture => Some("Tela de textura"),
        TextKey::ReferenceImages => Some("Referência"),
        TextKey::ReferenceImagesEmpty => Some("Sem imagens de referência"),
        TextKey::ReferenceImageUnreadable => {
            Some("Não foi possível ler esta imagem, por isso está na lista mas não no ecrã")
        }
        TextKey::ReferenceImageAdd => Some("Adicionar uma imagem"),
        TextKey::ReferenceImageRemove => Some("Remover"),
        TextKey::ReferenceImageLock => Some("Bloquear"),
        TextKey::ReferenceImageUnlock => Some("Desbloquear"),
        TextKey::ReferenceImageRaise => Some("Trazer para frente"),
        TextKey::ReferenceImageLower => Some("Enviar para trás"),
        TextKey::ReferenceHeadRow => Some("Cabeça"),
        TextKey::ReferenceHeadRowHint => Some("Imagens acima desta linha cobrem a cabeça"),
        TextKey::ShortcutTextureCanvasPan => Some("Mover a tela (segurar)"),
        TextKey::ShortcutDiagnosticLogCopy => Some("Copiar o registro"),
        TextKey::ShortcutLightRotate => Some("Girar a luz (segurar)"),
        TextKey::ShortcutLayerHide => Some("Ocultar camada"),
        TextKey::ShortcutLayerUnhideAll => Some("Mostrar todas as camadas"),
        TextKey::ShortcutLayerIsolate => Some("Ocultar as outras camadas"),
        TextKey::ShortcutLayerLocalView => Some("Ver apenas este (alternar)"),
        TextKey::ShortcutLayerInvertSelection => Some("Inverter a seleção"),
        TextKey::ShortcutLayerSelectAll => Some("Selecionar todas as camadas"),
        TextKey::ShortcutLayerRemove => Some("Excluir camadas selecionadas"),
        TextKey::ShortcutVertexSelectConnected => Some("Selecionar a madeixa toda"),
        TextKey::ShortcutVertexGrowSelection => Some("Aumentar a seleção"),
        TextKey::ShortcutVertexShrinkSelection => Some("Reduzir a seleção"),
        TextKey::ShortcutSculptSmoothHold => Some("Segurar para suavizar"),
        TextKey::ShortcutSculptInflateHold => Some("Segurar para inflar"),
        TextKey::ShortcutSculptAlternateHold => Some("Segurar para inverter"),
        TextKey::ShortcutHairSmoothHold => Some("Segurar para suavizar o cabelo"),
        TextKey::ShortcutHairInvertHold => Some("Segurar para inverter a ferramenta de cabelo"),
        TextKey::ShortcutTextureInvertHold => Some("Segurar para inverter a ferramenta de textura"),
        TextKey::ShortcutListAddToSelection => Some("Segurar para somar à seleção"),
        TextKey::ShortcutListSolo => Some("Segurar para isolar"),
        ...
        TextKey::SourceFilterAll => Some("Tudo"),
        ...
        TextKey::VertexRotateArmed => Some("Rodar · arraste · clique ou R para terminar"),
        TextKey::HelpVertexRotate => Some("Rodar seleção"),
        ...
        TextKey::MorphResolving => Some("A carregar morphs"),
        ...
        TextKey::ShortcutBrushSizeDrag => Some("Tamanho do pincel"),
        TextKey::ShortcutBrushStrengthDrag => Some("Força do pincel"),
        ...
        TextKey::CameraRoll => Some("Rotação"),
        ...
        TextKey::SculptBrushVertexTooltip => Some(
            "Move os pontos da malha. Clique para pegar num, arraste para mover, e use o gizmo para fixar um eixo.",
        ),
