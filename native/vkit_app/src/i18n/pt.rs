...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupAlignment => Some("Alinhamento"),
        TextKey::ShortcutGroupSculpt => Some("Escultura"),
        TextKey::ShortcutGroupHair => Some("Cabelo"),
        TextKey::ShortcutGroupView => Some("Vista"),
        TextKey::ShortcutGroupNavigation => Some("Navegação"),
