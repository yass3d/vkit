...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupSystem => Some("सर्वत्र"),
        TextKey::ShortcutGroupAlignment => Some("सिर रखना"),
        TextKey::ShortcutGroupSculpt => Some("स्कल्प्ट ब्रश"),
        TextKey::ShortcutGroupHair => Some("बाल ब्रश"),
        TextKey::ShortcutGroupView => Some("कैमरा व्यू"),
        TextKey::ShortcutGroupNavigation => Some("टैब बदलना"),
        TextKey::ShortcutViewReset => Some("कैमरा रीसेट करें"),
        TextKey::ShortcutViewProjection => Some("परिप्रेक्ष्य / ऑर्थोग्राफ़िक"),
        TextKey::ShortcutViewFront => Some("सामने का व्यू"),
        TextKey::ShortcutViewLeftSide => Some("बायाँ व्यू"),
        TextKey::ShortcutViewRightSide => Some("दायाँ व्यू"),
        TextKey::ShortcutViewTop => Some("ऊपर का व्यू"),
        TextKey::ShortcutViewBottom => Some("नीचे का व्यू"),
        TextKey::ShortcutViewFrontUpperLeft => Some("सामने ऊपर बाएँ"),
        TextKey::ShortcutViewFrontUpperRight => Some("सामने ऊपर दाएँ"),
        TextKey::ShortcutViewFrontLowerLeft => Some("सामने नीचे बाएँ"),
        TextKey::ShortcutViewFrontLowerRight => Some("सामने नीचे दाएँ"),
        TextKey::ShortcutTabFaceMatch => Some("चेहरा मिलान टैब"),
        TextKey::ShortcutTabDetail => Some("डिटेल टैब"),
        TextKey::ShortcutTabTexture => Some("टेक्सचर टैब"),
        TextKey::ShortcutTabHair => Some("बाल टैब"),
        TextKey::ShortcutTabSave => Some("सहेजें टैब"),
        TextKey::ShortcutGroupLists => Some("लेयर और पार्ट"),
        TextKey::ShortcutGroupVertex => Some("लट के बिंदु"),
        TextKey::ShortcutVertexAdd => Some("चयन में जोड़ने के लिए दबाए रखें"),
        TextKey::ShortcutVertexRemove => Some("चयन से हटाने के लिए दबाए रखें"),
        ...
        TextKey::ShortcutHairSmoothHold => Some("बाल स्मूद करने के लिए दबाए रखें"),
        TextKey::ShortcutHairInvertHold => Some("बाल टूल उलटने के लिए दबाए रखें"),
        TextKey::ShortcutTextureInvertHold => Some("टेक्सचर टूल उलटने के लिए दबाए रखें"),
        TextKey::ShortcutListAddToSelection => Some("चयन में जोड़ने के लिए दबाए रखें"),
        TextKey::ShortcutListSolo => Some("अकेला दिखाने के लिए दबाए रखें"),
        ...
        TextKey::ShortcutBrushSizeDrag => Some("ब्रश का आकार"),
        TextKey::ShortcutBrushStrengthDrag => Some("ब्रश की ताकत"),
