...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupView => Some("व्यू"),
        TextKey::ShortcutGroupNavigation => Some("नेविगेशन"),
        ...
        TextKey::ShortcutGroupLists => Some("सूचियाँ"),
        TextKey::ShortcutGroupTexture => Some("टेक्सचर"),
