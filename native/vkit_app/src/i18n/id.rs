...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupView => Some("Tampilan"),
        TextKey::ShortcutGroupNavigation => Some("Navigasi"),
        ...
        TextKey::ShortcutGroupLists => Some("Daftar"),
        TextKey::ShortcutGroupTexture => Some("Tekstur"),
