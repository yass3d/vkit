...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupVertex => Some("Titik untaian"),
        TextKey::ShortcutVertexAdd => Some("Tahan untuk menambah ke pilihan"),
        TextKey::ShortcutVertexRemove => Some("Tahan untuk mengeluarkan dari pilihan"),
