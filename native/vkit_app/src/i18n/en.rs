...
pub(super) const fn label(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ShortcutGroupVertex => "Strand joints",
        TextKey::ShortcutVertexAdd => "Hold to add to the selection",
        TextKey::ShortcutVertexRemove => "Hold to take out of the selection",
