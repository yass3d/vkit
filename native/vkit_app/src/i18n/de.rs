...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupView => Some("Ansicht"),
        TextKey::ShortcutGroupNavigation => Some("Navigation"),
        ...
        TextKey::ShortcutGroupLists => Some("Listen"),
        TextKey::ShortcutGroupTexture => Some("Textur"),
