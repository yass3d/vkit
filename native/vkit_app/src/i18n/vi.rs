...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupView => Some("Khung nhìn"),
        TextKey::ShortcutGroupNavigation => Some("Điều hướng"),
        ...
        TextKey::ShortcutGroupLists => Some("Danh sách"),
        TextKey::ShortcutGroupTexture => Some("Kết cấu"),
