...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupView => Some("ビュー"),
        TextKey::ShortcutGroupNavigation => Some("移動"),
        TextKey::ShortcutViewReset => Some("カメラをリセット"),
        TextKey::ShortcutViewProjection => Some("透視 / 平行投影"),
        TextKey::ShortcutViewFront => Some("正面ビュー"),
        TextKey::ShortcutViewLeftSide => Some("左ビュー"),
        TextKey::ShortcutViewRightSide => Some("右ビュー"),
        TextKey::ShortcutViewTop => Some("上ビュー"),
        TextKey::ShortcutViewBottom => Some("下ビュー"),
        TextKey::ShortcutViewFrontUpperLeft => Some("正面 左上"),
        TextKey::ShortcutViewFrontUpperRight => Some("正面 右上"),
        TextKey::ShortcutViewFrontLowerLeft => Some("正面 左下"),
        TextKey::ShortcutViewFrontLowerRight => Some("正面 右下"),
        TextKey::ShortcutTabFaceMatch => Some("顔マッチタブ"),
        TextKey::ShortcutTabDetail => Some("ディテールタブ"),
        TextKey::ShortcutTabTexture => Some("テクスチャタブ"),
        TextKey::ShortcutTabHair => Some("ヘアタブ"),
        TextKey::ShortcutTabSave => Some("保存タブ"),
