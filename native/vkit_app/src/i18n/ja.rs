...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::ShortcutGroupSystem => Some("全体"),
        TextKey::ShortcutGroupAlignment => Some("頭の配置"),
        TextKey::ShortcutGroupSculpt => Some("造形ブラシ"),
        TextKey::ShortcutGroupHair => Some("ヘアブラシ"),
        TextKey::ShortcutGroupView => Some("カメラビュー"),
        TextKey::ShortcutGroupNavigation => Some("タブ切り替え"),
        ...
        TextKey::ShortcutGroupLists => Some("レイヤーとパーツ"),
        TextKey::ShortcutGroupVertex => Some("ストランドの点"),
        TextKey::ShortcutVertexAdd => Some("押している間選択に追加"),
        TextKey::ShortcutVertexRemove => Some("押している間選択から除外"),
        ...
        TextKey::ShortcutHairSmoothHold => Some("押している間ヘアをスムーズ"),
        TextKey::ShortcutHairInvertHold => Some("押している間ヘアツールを逆に"),
        TextKey::ShortcutTextureInvertHold => Some("押している間テクスチャツールを逆に"),
        TextKey::ShortcutListAddToSelection => Some("押している間選択に追加"),
        TextKey::ShortcutListSolo => Some("押している間ひとつだけ表示"),
        ...
        TextKey::ShortcutBrushSizeDrag => Some("ブラシサイズ"),
        TextKey::ShortcutBrushStrengthDrag => Some("ブラシ強度"),
