...
pub(super) const fn label(key: TextKey) -> Option<&'static str> {
    ...
    match key {
        ...
        TextKey::CameraTrackballArmed => Some("Roulis armé · glisser latéralement pour incliner · clic ou R pour finir"),
        ...
        TextKey::UndoMorphReset => Some("Annuler la réinitialisation"),
